...
## 3. Gerenciamento de Seções

| ID         | Requisito                                                            | Prioridade |
|------------|----------------------------------------------------------------------|---|
| RF-SEC-001 | O sistema deve permitir que o gerente cadastre seções dinamicamente. | Essencial |
| RF-SEC-002 | O sistema deve permitir que o gerente altere os dados de uma seção.  | Essencial |
| RF-SEC-003 | O sistema deve permitir que o gerente desative uma seção.            | Importante |
| RF-SEC-004 | O sistema deve permitir a consulta das seções cadastradas.           | Essencial |
...
| ID | Requisito                                                                              | Prioridade |
|---|----------------------------------------------------------------------------------------|---|
| RF-COM-001 | O sistema deve permitir a abertura de uma comanda vinculada a uma seção.               | Essencial |
| RF-COM-002 | O sistema deve exigir o nome do cliente durante a abertura da comanda.                 | Essencial |
| RF-COM-003 | O sistema deve permitir visualizar as comandas abertas de uma determinada seção.       | Essencial |
...
| RF-COM-008 | O sistema deve permitir que uma comanda seja transferida de uma seção para outra.      | Essencial |
...
| RF-NOT-003 | O sistema deve permitir que o funcionário registre que o pedido foi entregue à seção.         | Essencial |
...
| RF-HIST-005 | O sistema deve permitir filtrar o histórico pela seção.                             | Importante |
